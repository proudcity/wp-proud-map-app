...
timeout&&$timeout.cancel(timeout)}};voidCompile=scope.$watch("lazyCompile",function(value,oldVal){var doRender=!rendered&&value&&"false"!==value&&value!==oldVal;doRender&&compile(value)}),timeoutVal&&(timeout=$timeout(function(){rendered||compile(timeoutVal)},parseInt(timeoutDur)))}}}]);